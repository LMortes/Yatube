...
class PostsPaginatorViewsTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        Post.objects.bulk_create([
            Post(text='Тестовый текст поста номер 1', author=cls.user),
            Post(text='Тестовый текст поста номер 2', author=cls.user),
            Post(text='Тестовый текст поста номер 3', author=cls.user),
            Post(text='Тестовый текст поста номер 4', author=cls.user),
            Post(text='Тестовый текст поста номер 5', author=cls.user),
            Post(text='Тестовый текст поста номер 6', author=cls.user),
            Post(text='Тестовый текст поста номер 7', author=cls.user),
            Post(text='Тестовый текст поста номер 8', author=cls.user),
            Post(text='Тестовый текст поста номер 9', author=cls.user),
            Post(text='Тестовый текст поста номер 10', author=cls.user),
            Post(text='Тестовый текст поста номер 11', author=cls.user),
            Post(text='Тестовый текст поста номер 12', author=cls.user),
            Post(text='Тестовый текст поста номер 13', author=cls.user)
        ])
